...
```{r create_output_directory, echo = FALSE, warning=FALSE}
...
blank.counts <- read.csv(
  file = "/Users/cabler/Box Sync/RNC_Duhaime_Lab/R_projects/gl_2014_count_data_github/final_directory/duhaime_gl_2014_blank_counts_all.csv")
...
blank.counts.data <- 
  write.csv(
    blank.counts, 
    file = "./outfiles_final/final_blank_counts_table.csv", 
    na = "NA")
